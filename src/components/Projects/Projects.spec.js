...
describe("Projects Component", () => {
  test("renders the Projects component", () => {
    ...
    expect(
      screen.getByText(
        /An internal application for reserving desks in the office/
      )
    ).toBeInTheDocument();
    expect(
      screen.getByText(/This platform is widely used in higher education/)
    ).toBeInTheDocument();
    expect(
      screen.getByText(/Platform designed to support universities and colleges/)
    ).toBeInTheDocument();
